...
gpt_get_chat_initialise = construct_chat_prompt(get_chat_initialise)
# def gpt_get_chat_initialise(context, practice_lang, persona, user_profile, practice_lang_prof, desired_scenario):
#     """This is the beginning of the conversation."""
#     pass

gpt_get_chat_response = construct_chat_prompt(get_chat_response)
...
gpt_get_user_comment = construct_teacher_prompt(get_user_comment)
...
gpt_get_bot_answer = construct_teacher_prompt(get_bot_answer)
...
gpt_get_bot_explain = construct_teacher_prompt(get_bot_explain)
